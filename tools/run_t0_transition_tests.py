...
LOG_PATH = PROJECT_DIR / "logs" / "godot_t0_transition_tests.log"
SUCCESS_MARKER = "SUCCÈS : transitions et persistance T0 validées."
...
def main() -> int:
    ...
    completed = subprocess.run([
        ...
        "--scene", "tools/t0_transition_tests.tscn",
    ])
