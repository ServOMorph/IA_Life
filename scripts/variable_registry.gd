...
const CHARACTER: Dictionary = {
	...
	"fixed_policy_danger": {"label": "Politique fixe danger", "description": "Réponse du décideur politique_fixe à un danger physiquement subi ou visible : l'ignorer (politique alimentaire inchangée), s'en éloigner, ou le viser (contrôle négatif). Surcouche à fixed_policy_s1/s2/s3, sans effet hors danger. Ignoré par les autres décideurs.", "scope": "individuelle", "category": "décision", "type": "enum", "options": ["ignorer", "eviter", "viser"], "default": "ignorer", "dynamic": false, "live_editable": false},
