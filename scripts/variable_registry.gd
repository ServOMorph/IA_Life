...
const CHARACTER: Dictionary = {
	...
	"decider_type": {"label": "Type de décideur", "description": "Système qui décide des actions de l'agent : automate déterministe, décideur adaptatif qui apprend pendant sa vie, LLM local via Ollama, ou LLM simulé sans appel réseau (test).", "scope": "individuelle", "category": "décision", "type": "enum", "options": ["automate", "adaptatif", "llm", "llm_mock"], "default": "automate", "dynamic": false, "live_editable": false},
