...
const GAME_CONFIG: Dictionary = {
	...
	"danger_zone_safety_radius": {"label": "Rayon de sécurité danger", "description": "Distance minimale entre une zone dangereuse et un spawn, un mur ou un roncier lors du placement.", "scope": "globale", "category": "environnement", "type": "float", "min": 0.0, "max": 100.0, "default": 12.0, "dynamic": false, "live_editable": false},
