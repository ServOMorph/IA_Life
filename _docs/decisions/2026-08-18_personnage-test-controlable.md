...
- `scripts/main.gd` : spawn du personnage de test, touche F5, calcul du déplacement relatif à
  la caméra (`_update_test_character_movement`), touche **E** : ramasse une mûre à portée
  du personnage de test, touche **H** = forcer faim basse (repas).
...
du rig Phase 5 — touche **K** ajoutée pour tuer le personnage de test à la demande). La touche E
a été affectée à la cueillette manuelle et le log de diagnostic temporaire a été retiré le
2026-08-23.
